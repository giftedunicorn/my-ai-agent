# AI Chatbot with Create T3 Turbo

A full-stack AI chatbot application built with Create T3 Turbo and Google Gemini, featuring multiple character personalities.

## ✨ Features

- 🤖 **Multiple AI Characters**: Choose from different personalities:
  - Default helpful assistant
  - Luffy from One Piece
  - Tony Stark (Iron Man)
  - Goku from Dragon Ball
- 💬 **Real-time Chat**: Seamless conversation experience
- 💾 **Message Persistence**: All messages are stored in PostgreSQL
...
```env
# Database (you can use Vercel Postgres, Supabase, or local PostgreSQL)
...
Visit `http://localhost:3000` and click "Start Chatting" to begin!

## 📖 Tutorial

For a complete step-by-step tutorial on how this chatbot was built, see [TUTORIAL.md](./TUTORIAL.md).
...
│       └── src/
│           └── schema.ts          # Message schema
└── TUTORIAL.md          # Complete tutorial
```

## 🎮 Usage

1. **Select a Character**: Choose from the dropdown (Default, Luffy, Iron Man, or Goku)
2. **Type a Message**: Enter your message in the input box
...
Each character has a unique personality defined in the system prompt:

- **Default**: Professional and helpful AI assistant
- **Luffy**: Energetic, loves meat, dreams of being Pirate King
- **Iron Man**: Witty, sarcastic, tech-focused genius
- **Goku**: Simple, loves training and fighting, always hungry

### API Endpoints

- `chat.sendChat`: Send a message and get AI response
- `chat.getMessages`: Retrieve all chat history
...
Vercel will automatically configure the database if you use Vercel Postgres.
...
# Original create-t3-turbo README
